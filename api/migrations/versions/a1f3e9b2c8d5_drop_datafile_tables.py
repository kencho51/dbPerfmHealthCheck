...
down_revision: str | Sequence[str] | None = "2c081eeee9d3"
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("raw_query_datafile_mongo", schema=None) as batch_op:
        batch_op.create_index(
            "ix_raw_query_datafile_mongo_environment", ["environment"], unique=False
        )
        batch_op.create_index(
            "ix_raw_query_datafile_mongo_host_mount", ["host_mount"], unique=False
        )
        batch_op.create_index(
            "ix_raw_query_datafile_mongo_month_year", ["month_year"], unique=False
        )
    ...
    with op.batch_alter_table("raw_query_datafile_sql", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "ix_raw_query_datafile_sql_environment", ["environment"], unique=False
        )
